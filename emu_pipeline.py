...
example = np.loadtxt(f"/u/chahermann/Sparkling/input/emu_input/{set}_set1_emu_run0000.dat")
...
for i in range(0, n):
    ...
    void_data_incl_small[void_key] = voidfinder_reader(f'/u/chahermann/Sparkling/output/emu_output/void_{filename}.dat')
    #void_data_incl_small[void_key] = voidfinder_reader(f'/Users/CHermann/Desktop/MPE/Bachelor_thesis/Revolver/output/emu_output/{filename}/zobov-Revolver_Voids_cat.txt')
...
z_max = 5
h=0.67
filename = f"{set}_set1_emu_run0000"

void_key = f"void_data_incl_small_{filename}"
radii_incl_small, coords_incl_small = void_data_incl_small[void_key]

data_particles = np.loadtxt(f'/u/chahermann/Sparkling/input/emu_input/{filename}.dat')
positions = data_particles[:, 0:3]
velocities = data_particles[:, 3:6]

mask = (coords_incl_small[:, 2] >= z_min) & (coords_incl_small[:, 2] <= z_max)
ax.scatter(coords_incl_small[mask, 0]/h, coords_incl_small[mask, 1]/h, s=30, c='darkorange', label='Voids', edgecolors='darkorange', linewidths=1, marker='x', zorder=2)
xlim = ax.get_xlim()
ylim = ax.get_ylim()
for x, y, r in zip(coords_incl_small[mask, 0]/h, coords_incl_small[mask, 1]/h, radii_incl_small[mask]/h):
    circle = patches.Circle((x, y), r, color='darkorange', fill=False, linewidth=1, alpha=1.0, zorder=3)
    ax.add_patch(circle)

# Plot dark matter particles in the (x, y) plane
mask_dm = (positions[:, 2] >= z_min) & (positions[:, 2] <= z_max)
ax.scatter(positions[mask_dm, 0]/h, positions[mask_dm, 1]/h, s=1, alpha=0.3, c='cyan', label='DM particles')
for spine in ax.spines.values():
    spine.set_edgecolor('white')

custom_legend = [ Line2D([0], [0], marker='x', color='darkorange', linestyle='None', markersize=8, label='$\mathrm{Voids}$'), Line2D([0], [0], marker='o', color='cyan', linestyle='None', markersize=5, alpha=0.8, label='$\mathrm{DM}$')]
...
ax.set_xlim(xlim)
ax.set_ylim(ylim)
#fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_spat_emu_{set}.png", dpi=100, bbox_inches='tight', pad_inches=0)
...
fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_VSF_emu_{set}.pdf")
...
for i in range(0, n):
    filename = f"{set}_set1_emu_run{i:04}"
    particles_data = np.loadtxt(f"/u/chahermann/Sparkling/input/emu_input/{filename}.dat")
...
for i in range(0, n):
    ...
    #save each file
    np.save(f"/u/chahermann/Emu_results/Numpy_files/{filename}_integrated_delta_profiles_population_spaced_groups.npy", (delta_profiles_groups, radii_groups))
    #np.save(f"/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_{filename}_integrated_delta_profiles_population_spaced_groups.npy", (delta_profiles_groups, radii_groups))
...
np.save(f"/u/chahermann/Emu_results/Numpy_files/all_integrated_delta_profiles_population_spaced_groups_{set}_new.npy", (all_delta_profiles_groups, all_radii_groups))
#np.save("/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_all_integrated_delta_profiles_population_spaced_groups.npy", (all_delta_profiles_groups, all_radii_groups))
...
for i, ax in enumerate(axes[:4], start=1):
    filename = f"{set}_set1_emu_run{i:04}"
    delta_profiles_groups, radii_groups = np.load(f"/u/chahermann/Emu_results/Numpy_files/{filename}_integrated_delta_profiles_population_spaced_groups.npy", allow_pickle=True)
...
plt.tight_layout()
fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_IDP_emu_{set}.pdf")
...
all_delta_profiles_groups, all_radii_groups = np.load(f"/u/chahermann/Emu_results/Numpy_files/all_integrated_delta_profiles_population_spaced_groups_{set}.npy", allow_pickle=True)
#all_delta_profiles_groups, all_radii_groups = np.load("/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_all_integrated_delta_profiles_population_spaced_groups.npy", allow_pickle=True)
...
fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_IDP_emu_mean_{set}.pdf")
...
for i in range(0, n):
    ...
    # Speichern pro File
    np.save(
        f"/u/chahermann/Emu_results/Numpy_files/{filename}_differential_delta_profiles_equipopulated_groups.npy",
        #f"/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_{filename}_differential_delta_profiles_equipopulated_groups.npy",
...
np.save(f"/u/chahermann/Emu_results/Numpy_files/all_differential_delta_profiles_equipopulated_groups_{set}.npy", (all_delta_profiles_groups, all_radii_groups))
#np.save("/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_all_differential_delta_profiles_equipopulated_groups.npy", (all_delta_profiles_groups, all_radii_groups))
...
for i, ax in enumerate(axes[:4], start=1):
    filename = f"{set}_set1_emu_run{i:04}"
    delta_profiles_groups, radii_groups = np.load(f"/u/chahermann/Emu_results/Numpy_files/{filename}_differential_delta_profiles_equipopulated_groups.npy", allow_pickle=True)
    #delta_profiles_groups, radii_groups = np.load(f"/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_{filename}_differential_delta_profiles_equipopulated_groups.npy", allow_pickle=True)
...
plt.tight_layout()
fig.subplots_adjust(wspace=0.15, hspace=0.25)
fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_DDP_emu_mean_{set}.pdf")
...
all_delta_profiles_groups, all_radii_groups = np.load(f"/u/chahermann/Emu_results/Numpy_files/all_differential_delta_profiles_equipopulated_groups_{set}.npy", allow_pickle=True)
#all_delta_profiles_groups, all_radii_groups = np.load("/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_all_differential_delta_profiles_equipopulated_groups.npy", allow_pickle=True)
...
for i in range(0, n):
    ...
    #save each file
    np.save(
         f"/u/chahermann/Emu_results/Numpy_files/{filename}_velocity_profiles_equipopulated_groups.npy",
        #f"/u/chahermann/Emu_results/Numpy_files/rev_{filename}_velocity_profiles_equipopulated_groups.npy",
    ...
    for group in velocity_profiles_groups:
        ...
        all_radii_groups[group].extend(radii_groups[group])
#save for all files
np.save(f"/u/chahermann/Emu_results/Numpy_files/all_velocity_profiles_equipopulated_groups_{set}.npy", (all_velocity_profiles_groups, all_radii_groups))
#np.save("/u/chahermann/Emu_results/Numpy_files/rev_all_velocity_profiles_equipopulated_groups.npy", (all_velocity_profiles_groups, all_radii_groups))
...
for i in range(1,5):
    filename = f"{set}_set1_emu_run{i:04}"
    velocity_profiles_groups, radii_groups = np.load(f"/u/chahermann/Emu_results/Numpy_files/{filename}_velocity_profiles_equipopulated_groups.npy", allow_pickle=True)
    #velocity_profiles_groups, radii_groups = np.load(f"/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_{filename}_velocity_profiles_equipopulated_groups.npy", allow_pickle=True)
    ax = axs[i-1]
    for group in velocity_profiles_groups:
...
fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_VP_emu_{set}.pdf")
...
#means
all_velocity_profiles_groups, all_radii_groups = np.load(f"/u/chahermann/Emu_results/Numpy_files/all_velocity_profiles_equipopulated_groups_{set}.npy", allow_pickle=True)
# all_velocity_profiles_groups, all_radii_groups = np.load("/Users/CHermann/Desktop/MPE/Bachelor_thesis/Emu_results/Numpy_files/rev_all_velocity_profiles_equipopulated_groups.npy", allow_pickle=True)
...
plt.tight_layout()
fig.savefig(f"/u/chahermann/Emu_results/Plots/sparkling_VP_emu_mean_{set}.pdf")
